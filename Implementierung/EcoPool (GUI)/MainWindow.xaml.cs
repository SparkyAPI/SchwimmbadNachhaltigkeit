...
namespace SchwimmbadNachhaltigkeit
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private const string ApiKey = "IHR OPENAI API-SCHLÜSSEL HIER REIN"; 
        private const string OpenAiEndpoint = "https://api.openai.com/v1/chat/completions";
        Reinigungsmittel mittel = new Reinigungsmittel();
        ...
        public MainWindow()
        {
            ...
            UpdateListView();
            LoadCleaningAgents();
            ReinigungsmittelComboBox.SelectedIndex = 1;
            ReinigungsmittelComboBox.IsDropDownOpen = false;
        }

        private void LoadCleaningAgents()
        {
            var cleaningAgents = mittel.meistGenutzteMittel();
            foreach (var agent in cleaningAgents)
            {
                ReinigungsmittelComboBox.Items.Add(agent);
            }
        }
        ...
        private void AddData_Click(object sender, RoutedEventArgs e)
        {
            if (string.IsNullOrWhiteSpace(WasserverbrauchInput.Text) ||
                string.IsNullOrWhiteSpace(ReinigungsmittelComboBox.Text) ||
            ...
            var daten = new NachhaltigkeitsDaten
            {
                ...
                Reinigungsmittel = ReinigungsmittelComboBox.Text,
